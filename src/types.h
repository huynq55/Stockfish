...
enum Square : int {
  ...
  SQ_A0, SQ_B0, SQ_C0, SQ_D0, SQ_E0, SQ_F0, SQ_G0, SQ_H0, SQ_I0, // 0 is actually 10, but abbreviated to make the code easier to see
  SQ_NONE,
...
enum Rank : int {
  RANK_1, RANK_2, RANK_3, RANK_4, RANK_5, RANK_6, RANK_7, RANK_8, RANK_9, RANK_0, RANK_NB
};
